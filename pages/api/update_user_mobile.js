...
export default async function updateUserPhone(req, res) {
    ...
    async function incomeUpdate() {
        const { user_sfid, mobile_otp, email_otp, mobile_id, email_id, mobile_nmber } = req.body;
        ...
        if (mobile_nmber == "" || mobile_nmber == undefined)
        ...
        try {
            ...
            const mobileNo  = String(mobile_nmber);
